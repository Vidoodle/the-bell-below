...
export const characters: CharacterProfile[] = [
  {
    ...
    prologue: "Seren remembers the order that closed the abbey and the voices on its other side. Some of the soldiers now guarding the Breach Stair once served beneath him; others know only the honored version of his name.",
    benefit: "Might",
  },
  {
    ...
    prologue: "Veyra's patron paid half in advance and supplied a rubbing of the clapper's seal. The official entrance is watched, but smugglers once used the cellars along the buried abbey wall—and Veyra knows where to look for their marks.",
    benefit: "Grace",
  },
  {
    ...
    prologue: "Cael carries copied fragments the church ordered destroyed: burial tallies that do not match the city's memorials and ritual diagrams scratched out of later editions. His censure is public, and the watch has been warned about his interest in the abbey.",
    benefit: "Wits",
  },
  {
