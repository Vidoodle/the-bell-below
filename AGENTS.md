...
- Aim for 200–300 lines of human-authored production code per review, excluding tests, migrations, and generated files. This is a reviewability target, not a reason to compress clear code. If a coherent ticket would substantially exceed it, split and sequence the ticket before implementation.
- Keep each resulting change as small as its coherent slice permits. Remove speculative abstractions, duplicate logic, and unrelated cleanup before review.
