...
from wayfarer.adventure.schema import AdventureDefinition, FactAudience
from wayfarer.domain.ids import ContentVersion, RunId
...
def _always() -> Predicate:
    from wayfarer.adventure.dsl import Always
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate versioned Wayfarer adventure content")
